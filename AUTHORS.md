...
تيار (Tayyar) — Social Platform for Arab Designers
Based on [Mastodon](https://github.com/mastodon/mastodon)

Copyright (c) 2025 7X Corporation. All rights reserved.

Modifications and customizations for "Tayyar" by **7X Corporation**.

---

This project incorporates original work from Mastodon,
available on [GitHub](https://github.com/mastodon/mastodon)
